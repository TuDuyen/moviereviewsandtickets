        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieStatusId = table.Column<byte>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Movies_MovieStatuses_MovieStatusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Casts", x => new { x.MovieId, x.Name });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieLikes", x => new { x.AccountId, x.MovieId });
                    table.ForeignKey(
                        name: "FK_MovieLikes_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ratings = table.Column<byte>(nullable: false),
                    Spoilers = table.Column<bool>(nullable: false),
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    MovieId = table.Column<int>(nullable: false),
                    AccountId = table.Column<int>(nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeatsInOrders", x => new { x.SeatId, x.OrderId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReviewLikes", x => new { x.AccountId, x.ReviewId });
                    table.ForeignKey(
                        name: "FK_ReviewLikes_AspNetUsers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "a7d42b38-4624-470b-8deb-13d2889e2897", "User", "user" },
                    { 2, "457c56a0-501b-4230-ad6c-c80d0a99622d", "Admin", "admin" },
                    { 3, "796f2dac-fa81-42c3-b716-247dd6b9870f", "Super Admin", "super admin" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "33235a53-dffd-4154-8fb9-2026e05e9815", "17110214@student.hcmute.edu.vn", true, false, null, null, "tnnhuquynh", "AQAAAAEAACcQAAAAEPdDPytamsUjxaXhMdaDa8dVRxV95cmPYeVx4ErEbDmoJya2IMa14Ag2uiT14PJKXA==", null, false, null, false, "tnnhuquynh" });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AccountId", "Area", "Fullname", "Image" },
                values: new object[] { 1, 1, null, "Tôn Nữ Như Quỳnh", null });
